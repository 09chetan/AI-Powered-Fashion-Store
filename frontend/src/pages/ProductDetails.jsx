...
function ProductDetails() {
    ...
    const fetchProductData = async () => {
        ...
        if (foundProduct) {
            ...
            // ✅ only set main image if not already selected
            setImage((prev) => prev || foundProduct.image1)
        }
    }
    ...
    return productData ? (
        <div>
                    ...
                    <div className='flex flex-col gap-[10px] my-[10px]'>
                        ...
                        <div className='flex gap-2'>
                            {productData.sizes.map((item, index) => (
                                <button
                                    key={index}
                                    className={`border py-2 px-4 bg-slate-300 rounded-md ${item === size ? 'bg-[#86f8b7]' : ''}`}
            ...
            <div className='w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden'>
                <div className='flex px-[20px] mt-[90px] lg:m1-[80px] m1-[0px] lg:mt-[0px]'>
                ...
                <div className='w-[80%] md:h-[150px] h-[220px] bg-[#333639c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:m1-[100px] m1-[20px]'>
