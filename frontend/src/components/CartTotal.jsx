...
//   return (
//     <div className='w-full lg:m1-[30px]'>
...
// [18px] p-[10px]'>
//         <b>Total</b>
//         <b>{currency} {getCartAmount() === 0 ? 0 : getCartAmount()
//           + delivery_fee}</b>
//       </div>
//     </div>
...
function CartTotal() {
  ...
  return (
    <div className='w-full lg:ml-[30px]'>
      ...
      <div className='flex flex-col gap-2 mt-2 text-sm p-[30px] border-[2px] border-[#4d8890]'>
        <p className='text-white text-[18px] p-[10px]'>  Subtotal</p>
        <p className='text-white text-[18px] p-[10px]'>{currency} {getCartAmount()}.00</p>
      </div>
      <hr />
